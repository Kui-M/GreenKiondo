...
public class PastaActivity extends AppCompatActivity {
    // Log tag
    private static final String TAG = PastaActivity.class.getSimpleName();

    // Movies json url
    private static final String url = "http://food2fork.com/api/search?key=965c095439caf056aa29b3f87c0f71ae&q=pasta";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = findViewById(R.id.list_pasta);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                Intent rdetail = new Intent( PastaActivity.this,RecipeDetailActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        switch(item.getItemId()){
            case R.id.action_my_kiondo:
                Intent mk = new Intent(PastaActivity.this,MyKiondoActivity.class);
                startActivity(mk);
                return true;
            default:
