...
public class DessertActivity extends AppCompatActivity {
    ...
    private static final String TAG = DessertActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                Intent rdetail = new Intent( DessertActivity.this,RecipeDetailActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        switch(item.getItemId()){
            case R.id.action_my_kiondo:
                Intent mk = new Intent(DessertActivity.this,MyKiondoActivity.class);
                startActivity(mk);
                return true;
            default:
