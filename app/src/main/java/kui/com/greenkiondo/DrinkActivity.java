...
public class DrinkActivity extends AppCompatActivity {
    ...
    // Movies json url
    private static final String url = "http://food2fork.com/api/search?key=965c095439caf056aa29b3f87c0f71ae&q=drink";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = findViewById(R.id.list_drink);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                Intent rdetail = new Intent( DrinkActivity.this,RecipeDetailActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        switch(item.getItemId()){
            case R.id.action_my_kiondo:
                Intent mk = new Intent(DrinkActivity.this,MyKiondoActivity.class);
                startActivity(mk);
                return true;
            default:
