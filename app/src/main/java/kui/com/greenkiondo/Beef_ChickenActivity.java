...
public class Beef_ChickenActivity extends AppCompatActivity {

    // Log tag
    private static final String TAG = Beef_ChickenActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                Intent rdetail = new Intent( Beef_ChickenActivity.this,RecipeDetailActivity.class);
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.GET,
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        //hiding the progress bar after completion
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_my_kiondo:
                Intent mk = new Intent(Beef_ChickenActivity.this, MyKiondoActivity.class);
                startActivity(mk);
                return true;
            default:
